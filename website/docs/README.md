...
- **Preislogik:** Orientierung Fliesen-Weber-Demo – `Fläche × €/m² (Material) × Projekt-Multiplikator` + Extras pro m², Spanne 93–112 % (gerundet 10 €). Konfiguration in `website/js/calc.js` → `CONFIG`.
